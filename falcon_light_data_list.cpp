...
std::vector<FalconLightData>	init_falcon_light_data_list()
{
	std::vector<FalconLightData>	retval{
		...
		create_FalconLightData_struct("FLCS PMG light (ELEC panel)",	FlightData::LightBits3::FlcsPmg,		&flightData.lightBits3),
		create_FalconLightData_struct("MAIN GEN light (ELEC panel)",	FlightData::LightBits3::MainGen,		&flightData.lightBits3),
		create_FalconLightData_struct("STBY GEN light (ELEC panel)",	FlightData::LightBits3::StbyGen,		&flightData.lightBits3),
		create_FalconLightData_struct("EPU GEN light (ELEC panel)",		FlightData::LightBits3::EpuGen,			&flightData.lightBits3),
		create_FalconLightData_struct("EPU PMG light (ELEC panel)",		FlightData::LightBits3::EpuPmg,			&flightData.lightBits3),
		create_FalconLightData_struct("TO FLCS light (ELEC panel)",		FlightData::LightBits3::ToFlcs,			&flightData.lightBits3),
		create_FalconLightData_struct("FLCS RLY light (ELEC panel)",	FlightData::LightBits3::FlcsRly,		&flightData.lightBits3),
		create_FalconLightData_struct("FAIL light (ELEC panel)",		FlightData::LightBits3::BatFail,		&flightData.lightBits3),
